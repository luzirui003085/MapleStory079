...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L1##b" + 红色箭头 + "制作#v1002939##z1002939#\t需要：#r#v4310015#x150#k个\r\n\r\n"//
            text += "#L2##b" + 红色箭头 + "制作#v1082149##z1082149#\t需要：#r#v4310015#x100#k个\r\n\r\n"//
            text += "#L3##b" + 红色箭头 + "制作#v1102041##z1102041#\t需要：#r#v4310015#x150#k个\r\n\r\n"//
            text += "#L4##b" + 红色箭头 + "制作#v1102042##z1102042#\t需要：#r#v4310015#x100#k个\r\n\r\n"//
            text += "#L5##b" + 红色箭头 + "制作#v1112793##z1112793#\t需要：#r#v4310015#x250#k个\r\n\r\n"//
            //text += "#L6##b" + 红色箭头 + "制作微信独家制作，专用版神级【坐骑】，可以爬绳子，可以上下坐骑，不用右键取消！\r\n"//
            text += "#L7##b" + 红色箭头 + "制作#v3010070##z3010070#\t需要：#r#v4310015#x300#k个\r\n\r\n"//
