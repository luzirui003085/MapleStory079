...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#L7##b" + 蓝色角点 + "发型脸型#l#l#L5##b" + 蓝色角点 + "删除物品#l#l#L6##b" + 蓝色角点 + "点券商城#l\r\n\r\n#L999##b" + 蓝色角点 + "快速转职#l#L1999##b" + 蓝色角点 + "皇家骑宠#l#L11999##b" + 蓝色角点 + "副本系统#l\r\n\r\n#L111999##b" + 蓝色角点 + "随身音乐#l#L1111999##b" + 蓝色角点 + "兑换系统#l#L14##b" + 蓝色角点 + "兑换商人#l#l\r\n\r\n#L2999##b" + 蓝色角点 + "每日任务#l#L3999##b" + 蓝色角点 + "每日签到#l#L4999##b" + 蓝色角点 + "流浪商人#l#l\r\n\r\n#L5999##b" + 蓝色角点 + "血衣制作#l#L6999##b" + 蓝色角点 + "金叶抽奖#l#L7999##b" + 蓝色角点 + "觉醒商人#l#l\r\n\r\n#L8999##b" + 蓝色角点 + "21点游戏#l#L9999##b" + 蓝色角点 + "开锁游戏#l#L10999##b" + 蓝色角点 + "查看爆率#l#l\r\n\r\n"//3
