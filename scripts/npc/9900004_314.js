    ...
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			if (cm.getMeso() < 1000000) { 
				...
				cm.dispose();
			} else if (cm.itemQuantity(1412027) < 1 ) { 
				cm.sendOk("#b装备强化需要#v1412027#1个，您的物品不足#k");
				cm.dispose();
