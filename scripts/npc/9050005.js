	...
	text += "     \r\n"
        cm.sendSimple(text);
				...
				cm.gainItem(1142007, -1);
                                cm.gainItem(1142007,500,500,500,500,500,500,200,200,350,350,350,350,30,30);
