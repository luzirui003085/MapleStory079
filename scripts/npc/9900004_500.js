...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "" + 蓝色箭头 + "#L1#领取#v1003439##z1003439#\t需要物品：#v4310057# x1个\t使用时间永久\r\n\r\n"//3
...
cm.gainItem(1003439,3,3,3,0,0,0,0,0,50,50,20,20,0,0);
cm.喇叭(2, "管理员赠送[" + cm.getPlayer().getName() + "]一个【粉色扎昆头盔】，做为对你努力升级的奖赏，要继续加油哦！！");
            cm.dispose();
			}else{
