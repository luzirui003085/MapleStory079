    ...
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			if (cm.getMeso() < 1000000) { 
				...
				cm.sendOk("#b装备强化需要#v1442051#1个，您的物品不足#k");
				cm.dispose();
