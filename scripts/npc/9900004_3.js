...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L1##e#dLv10.月妙组队副本#l\t#L2##dLv21.废弃组队副本#l\r\n\r\n"//3
            text += "#L3##dLv35.玩具组队副本#l\t#L4##dLv51.天空组队副本#l\r\n\r\n"//3
            text += "#L5##dLv100.毒物组队副本#l\t#L6##dLv55.海盗组队副本#l\r\n\r\n"//3
            text += "#L7##dLv70.罗密欧与朱丽叶组队副本#l\r\n\r\n"//3
