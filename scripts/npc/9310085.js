...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#e#d皇家骑宠抽奖NPC欢迎您的光临！\r\n使用方法：抽取之后，请点击自己技能栏，新手技能栏有白雪人头像技能，使用技能查看抽取坐骑外贸，再次兑换变换其中，随机到自己喜欢的，就不必随机了，永久使用，下骑宠右键点击BUFF图标即可。#l\r\n\r\n"//3
          ...
          //  text += "#L4##r购买#v4001215#100张 180000点卷#l\r\n\r\n"//3
			...
			cm.worldMessage(6,"玩家：["+cm.getName()+"]抽取[皇家骑宠]会是什么精美骑宠呢？点击新手栏白雪人技能查看把！");
            cm.dispose();
			}else{
            cm.sendOk("您的材料不足！");
            cm.dispose();
