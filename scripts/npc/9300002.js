	...
	text += "     \r\n"
        cm.sendSimple(text);
				...
				cm.gainItem(1142007, -1);
                                cm.gainItem(1142007,600,600,600,600,600,600,300,300,350,350,350,350,30,30);
